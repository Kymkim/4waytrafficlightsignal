...
namespace eval ::optrace {
  variable script "C:/archive/4waytrafficlightsignal/Hybrid/FixedSequenceTrafficLightStateMachine.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/archive/4waytrafficlightsignal/Hybrid/FixedSequenceTrafficLightStateMachine.runs/synth_1/top.dcp
