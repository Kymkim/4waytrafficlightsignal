...
HD_PWD='C:/archive/4waytrafficlightsignal/TrafficLightSignal/TrafficLightSignal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ringA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ringA.tcl
