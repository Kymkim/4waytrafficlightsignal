...
HD_PWD='C:/archive/4waytrafficlightsignal/TrafficLightSignal/TrafficLightSignal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ringA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ringA.tcl -notrace
